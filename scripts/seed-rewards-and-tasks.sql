...
insert into task(activity_type, title, points, target_count, status, auto_generated, center_latitude, center_longitude) values
                                                                                                                            ...
                                                                                                                            ('REVIEW', 'Проверьте три точки с жалобами на покрытие', 35, 3, 'ACTIVE', false, 59.9298, 30.3420),
                                                                                                                            ('REVIEW', 'Оцените три входа в общественные здания', 35, 3, 'ACTIVE', false, 59.9380, 30.3146),
                                                                                                                            ('REVIEW', 'Проверьте три маршрута к остановкам транспорта', 40, 3, 'ACTIVE', false, 59.9441, 30.3600),
                                                                                                                            ('REVIEW', 'Оцените три дворовых прохода после дождя', 35, 3, 'ACTIVE', false, 59.9500, 30.3200),
                                                                                                                            ('REVIEW', 'Проверьте три пандуса в центральном районе', 45, 3, 'ACTIVE', false, 59.9200, 30.3500),
                                                                                                                            ('REVIEW', 'Оцените три узких участка тротуара', 35, 3, 'ACTIVE', false, 59.9600, 30.3100),
                                                                                                                            ('REVIEW', 'Проверьте три опасных бордюра на маршруте', 40, 3, 'ACTIVE', false, 59.9700, 30.3000),
                                                                                                                            ('REVIEW', 'Оцените три точки около социальных учреждений', 45, 3, 'ACTIVE', false, 59.9100, 30.3300),
                                                                                                                            ('REVIEW', 'Проверьте пять мало проверенных точек у парков', 55, 5, 'ACTIVE', false, 59.9450, 30.2900),
                                                                                                                            ('REVIEW', 'Оцените пять переходов на популярных маршрутах', 55, 5, 'ACTIVE', false, 59.9350, 30.3800),
                                                                                                                            ('REVIEW', 'Проверьте пять препятствий около остановок', 60, 5, 'ACTIVE', false, 59.9250, 30.3000),
                                                                                                                            ('REVIEW', 'Оцените пять точек с низким числом отзывов', 60, 5, 'ACTIVE', false, 59.9550, 30.3400),
                                                                                                                            ('REVIEW', 'Проверьте пять участков около учебных зданий', 65, 5, 'ACTIVE', false, 59.9650, 30.3600),
                                                                                                                            ('REVIEW', 'Оцените пять входов и съездов на тротуарах', 65, 5, 'ACTIVE', false, 59.9150, 30.3100),
                                                                                                                            ('REVIEW', 'Проверьте пять сложных мест у больниц и аптек', 70, 5, 'ACTIVE', false, 59.9050, 30.3700),
                                                                                                                            ('REVIEW', 'Оцените пять точек на вечернем маршруте', 60, 5, 'ACTIVE', false, 59.9750, 30.3300),
                                                                                                                            ('REVIEW', 'Проверьте десять старых отметок на карте', 110, 10, 'ACTIVE', false, 59.9400, 30.3300),
                                                                                                                            ('REVIEW', 'Оцените десять препятствий в соседних кварталах', 115, 10, 'ACTIVE', false, 59.9300, 30.3200),
                                                                                                                            ('REVIEW', 'Проверьте десять точек без свежих отзывов', 120, 10, 'ACTIVE', false, 59.9200, 30.3100),
                                                                                                                            ('REVIEW', 'Оцените десять объектов городской доступности', 120, 10, 'ACTIVE', false, 59.9100, 30.3000),
                                                                                                                            ('REVIEW', 'Проверьте десять маршрутов вокруг кампуса', 125, 10, 'ACTIVE', false, 59.9000, 30.3400),
                                                                                                                            ('REVIEW', 'Оцените десять точек на длинной прогулке', 130, 10, 'ACTIVE', false, 59.9800, 30.3500),
                                                                                                                            ('REVIEW', 'Проверьте десять мест с возможными барьерами', 130, 10, 'ACTIVE', false, 59.9900, 30.3600),
                                                                                                                            ('VOLUNTEER', 'Помогите одному человеку дойти до остановки', 50, 1, 'ACTIVE', false, 59.9343, 30.3351),
                                                                                                                            ('VOLUNTEER', 'Помогите одному человеку на коротком маршруте', 50, 1, 'ACTIVE', false, 59.9311, 30.3609),
                                                                                                                            ('VOLUNTEER', 'Сопроводите одного человека до аптеки', 60, 1, 'ACTIVE', false, 59.9298, 30.3420),
                                                                                                                            ('VOLUNTEER', 'Помогите одному человеку перейти сложный участок', 60, 1, 'ACTIVE', false, 59.9380, 30.3146),
                                                                                                                            ('VOLUNTEER', 'Сопроводите одного человека до транспорта', 55, 1, 'ACTIVE', false, 59.9441, 30.3600),
                                                                                                                            ('VOLUNTEER', 'Помогите одному человеку с прогулкой вечером', 65, 1, 'ACTIVE', false, 59.9500, 30.3200),
                                                                                                                            ('VOLUNTEER', 'Сопроводите одного человека по знакомому району', 55, 1, 'ACTIVE', false, 59.9600, 30.3100),
                                                                                                                            ('VOLUNTEER', 'Помогите одному человеку с маршрутом до магазина', 60, 1, 'ACTIVE', false, 59.9700, 30.3000),
                                                                                                                            ('VOLUNTEER', 'Сопроводите одного человека после учебы', 60, 1, 'ACTIVE', false, 59.9100, 30.3300),
                                                                                                                            ('VOLUNTEER', 'Помогите одному человеку пройти маршрут без барьеров', 65, 1, 'ACTIVE', false, 59.9450, 30.2900),
                                                                                                                            ('VOLUNTEER', 'Помогите трем людям с прогулками у метро', 120, 3, 'ACTIVE', false, 59.9350, 30.3800),
                                                                                                                            ('VOLUNTEER', 'Сопроводите трех людей на непересекающихся маршрутах', 130, 3, 'ACTIVE', false, 59.9250, 30.3000),
                                                                                                                            ('VOLUNTEER', 'Помогите трем людям в соседних кварталах', 120, 3, 'ACTIVE', false, 59.9550, 30.3400),
                                                                                                                            ('VOLUNTEER', 'Сопроводите трех людей до остановок', 130, 3, 'ACTIVE', false, 59.9650, 30.3600),
                                                                                                                            ('VOLUNTEER', 'Помогите трем людям с дневными прогулками', 125, 3, 'ACTIVE', false, 59.9150, 30.3100),
                                                                                                                            ('VOLUNTEER', 'Сопроводите трех людей по коротким маршрутам', 125, 3, 'ACTIVE', false, 59.9050, 30.3700),
                                                                                                                            ('VOLUNTEER', 'Помогите трем людям около социальных объектов', 135, 3, 'ACTIVE', false, 59.9750, 30.3300),
                                                                                                                            ('VOLUNTEER', 'Сопроводите трех людей в разное время дня', 135, 3, 'ACTIVE', false, 59.9400, 30.3300),
                                                                                                                            ('VOLUNTEER', 'Помогите трем людям с безопасным маршрутом', 140, 3, 'ACTIVE', false, 59.9300, 30.3200),
                                                                                                                            ('VOLUNTEER', 'Сопроводите трех людей рядом с кампусом', 140, 3, 'ACTIVE', false, 59.9200, 30.3100),
                                                                                                                            ('VOLUNTEER', 'Помогите трем людям на маршрутах без пересечений', 145, 3, 'ACTIVE', false, 59.9100, 30.3000),
                                                                                                                            ('VOLUNTEER', 'Сопроводите трех людей в разных районах', 145, 3, 'ACTIVE', false, 59.9000, 30.3400),
                                                                                                                            ...
                                                                                                                            ('VOLUNTEER', 'Помогите трем людям с прогулками рядом с вами', 120, 3, 'ACTIVE', false, 59.9343, 30.3351)
    on conflict do nothing;
