...
| Кеши              | Redis                      | Кеширование запросов к GraphHopper            |
...
| `rewards`          | Магазин наград, история операция и таблица лидеров            |
...
| `model`            | Основные сущности для работы с GraphHopper                    |
